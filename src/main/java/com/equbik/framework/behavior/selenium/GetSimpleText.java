...
public class GetSimpleText implements TakeAction {
    ...
    public GetSimpleText(Execution execution, Element element, AWebElement advancedElement) {
    ...
    public ActionResult takeAction() {
        ...
        try {
            ...
            String context = wait.until(ExpectedConditions.visibilityOf(modifiedWebElement)).getText();
            additionalMessage.put("context", context);
