...
public class JSExecutor implements TakeAction {
    ...
    public JSExecutor(Execution execution, Element element, AWebElement advancedElement) {
    ...
    public Results takeAction() {
        ...
        try {
            ...
            jsExecutor.executeScript(element.getCode(), modifiedWebElement);
