...
public class SetCurrentWindow implements TakeAction {
    ...
    public SetCurrentWindow(Execution execution, Element element, AWebElement advancedElement) {
    ...
    public Results takeAction() {
        ...
        try {
            ...
            StaticVariables.tabs.add(currentWindow);
