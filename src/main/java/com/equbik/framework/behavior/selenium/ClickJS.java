...
public class ClickJS implements TakeAction {
    ...
    public ClickJS(Execution execution, Element element, AWebElement advancedElement) {
    ...
    public ActionResult takeAction() {
        ...
        try {
            ...
            jsExecutor.executeScript("arguments[0].click();", modifiedWebElement);
