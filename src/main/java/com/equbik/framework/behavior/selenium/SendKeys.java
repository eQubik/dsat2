...
public class SendKeys implements TakeAction {
    ...
    public SendKeys(Execution execution, Element element, AWebElement advancedElement) {
    ...
    public ActionResult takeAction() {
        ...
        try {
            ...
            modifiedWebElement.sendKeys(element.getValue());
