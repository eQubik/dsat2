...
public class FocusAndClick implements TakeAction {
    ...
    public FocusAndClick(Execution execution, Element element, AWebElement advancedElement) {
    ...
    public ActionResult takeAction() {
        ...
        try {
            ...
            action.moveToElement(modifiedWebElement).perform();
            modifiedWebElement = wait.until(ExpectedConditions.elementToBeClickable(modifiedWebElement));
